...
class Home extends MX_Controller {
    ...
    public function index() {
        ...
        if ($this->input->post('type')) { 
            ...
            if ($this->input->post('location_keyword') && 1==2) { 
    ...
    public function news_details() {
     ...
     public function news_details2() {
        $data['language'] = "language";
        $this->load->view('single_news2',$data);
    }
     public function news_details3() {
        $data['language'] = "language";
        $this->load->view('single_news3',$data);
    }
     public function news_details4() {
        $data['language'] = "language";
        $this->load->view('single_news4',$data);
    }
