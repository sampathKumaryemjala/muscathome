...
class Job_post extends MX_Controller {
    ...
    public function index() {
        ...
        if (isset($_GET['ghvj'])) {
            ...
            } if ($sub['cat_id'] == 1 or $sub['cat_id'] == 2 or $sub['cat_id'] == 3) {
...
//        }
    ...
    public function job_detail() {
        if (isset($_GET['jhj'])) {
            ...
            if(isset($_GET['hjfh'])){
                ...
                $fetch = $this->db->query("Select fk_service_cat_id from re_job_posts where id=".$filter['fk_job_post_id'])->row_array();
                $filter['fk_service_cat_id'] = $fetch['fk_service_cat_id'];
            }
    ...
    public function provider_job_detail() {
        ...
        if (isset($_GET['jhj'])) {
            ...
            $data['post_details'][0]['category'] = $filter['fk_service_cat_id'];
            //pre(); die;
            if ($this->input->post()) {
                ...
                //pre($inputs);die;
                $sender = $this->User_model->get_user(array('id'=> $this->session->userdata('active_user_data')['id']));
                if (isset($inputs['job_req_id'])) {
                    ...
                    $n_data['fk_user_id'] = $inputs['fk_customer_id'];
                    $n_data['fk_job_post_id'] = $inputs['fk_job_post_id'];
                    //$n_data['fk_service_cat_id'] = $filter['fk_service_cat_id'];
                    $n_data['notification_type'] = 5;
                    $n_data['description'] = $n_data['title'] = $sender['name'] . " is change the quotation for your service name request, Please accept to start the work ";
                    ...
                    $n_data['fk_job_post_id'] = $inputs['fk_job_post_id'];
                    //$n_data['fk_service_cat_id'] = $filter['fk_service_cat_id'];
                    $n_data['notification_type'] = 4;
                    $n_data['description'] = $n_data['title'] = $sender['name'] . " sent you quotation for your service, You can accept if you are fine with charges";
                    $this->Notifications_model->create_notification($n_data);
    ...
    public function servent_details() {
        ...
        if ($this->input->post()) {
            ...
            $input['request_sub_cat'] = $data['servent_detail']['sub_cat_name'];
