...
<!--                        <div id="address" class="detail-address detail-block target-block">
                        ...
                        <div id="detail" class="detail-list detail-block target-block">
                            ...
                            <div class="alert alert-info">
                                <ul class="list-three-col">
                                    <li><strong>Property ID:</strong> <?php echo $property['property_code'] ?></li><li><strong>Property Type:</strong> <?php echo $property['property_type'] ?></li><li><strong>Price: </strong><?php
                                        if ($property['type'] == 1) {
                                            echo "OMR " . number_format_short($property['price']) . "/mo";
                                        } else {
                                            echo "OMR " . number_format_short($property['price']);
                                        }
                                        ?></li><li><strong>Property Size: </strong> <?php echo $property['property_size'] ?> Sq M</li><?php if($property['property_type_id'] != 1 && $property['property_type_id'] != 4 && $property['property_type_id'] != 10){ ?><li><strong>Bedrooms:</strong> <?php echo $property['beds'] ?></li><li><strong>Bathrooms:</strong> <?php echo $property['baths']; } ?></li><!--<li><strong>Garage:</strong> 1</li><li><strong>Garage Size:</strong> 200 SqFt</li><li><strong>Year Built:</strong> 2016-01-09</li>-->        </ul>
                            </div>
                        </div>
                        ...
                        <div class="widget-body">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="amenities">
                                        <?php if($similiar_property['property_type'] != "Office" && $similiar_property['property_type'] != "Land" && $similiar_property['property_type'] != "Industrial"){ ?><p><?php echo $similiar_property['beds'] ?> beds • <?php echo $similiar_property['baths'] ?> baths • <?php echo $similiar_property['property_size'] ?> Sq M</p><?php } ?>
