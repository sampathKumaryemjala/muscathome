...
<!--                                <input class="form-control" type="text" value="" name="keyword" placeholder="Enter keyword...">-->
                    ...
                    <div class="advance-fields">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                <div class="form-group">
                                    <select name="area" id="area" class="selectpicker" data-live-search="false" data-live-search-style="begins" title="">
                                        ...
                                        <option value="1" <?php
                                        if (isset($serch_inputs['square_ft_min']) && $serch_inputs['square_ft_min'] <= 600) {
                                            echo "Selected";
                                        }
                                        ?>>0 - 600 sqm</option>
                                        <option value="2"<?php
                            ...
                            <input type="hidden" name="square_ft_min" id="square_ft_min" value="<?php
                            if (isset($serch_inputs['square_ft_min'])) {
                                echo $serch_inputs['square_ft_min'];
                            }
                            ?>">
                            <input type="hidden" name="square_ft_max" id="square_ft_max" value="<?php
            ...
            ?>
                        ...
                        var a<?php echo $i; ?> = {
                            info: '<strong> <?php echo $property['property_name']; ?></strong><br>\
                                                                              <strong>Beds:</strong><?php echo $property['beds'] . "   "; ?><strong>Baths:</strong><?php echo $property['baths']; ?><br>\
