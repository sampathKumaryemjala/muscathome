            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="pull-right active">Posted Jobs</li>
                        <li class="pull-right" ><a href="<?php echo base_url('index.php/web_panel/Home')?>">Home</a></li>
                        <li class="pull-left"><h1 class="title-head">Posted Jobs</h1></li>
                    </ol>
        ...
        <div class="row">
            <div class="col-sm-12 list-grid-area">
                <div id="content-area">
                    ...
                    <div class="list-tabs table-list full-width">
                        <div class="tabs table-cell">
                            <ul style="margin-left: -15px;">
                                <li>
                                    <a class="tab_filter to_be_active4" data-bind="4" id="4" href="<?php echo base_url('index.php/web_panel/Job_post/user_posts/all'); ?>">ALL JOBS</a>
                                </li>
                                <li>
                                    <a class="tab_filter to_be_active0" data-bind="0" id="0" href="<?php echo base_url('index.php/web_panel/Job_post/user_posts/pending'); ?>">PENDING</a>
                                </li>
                                
                                <li>
                                    <a class="tab_filter to_be_active2" data-bind="2" id="2" href="<?php echo base_url('index.php/web_panel/Job_post/user_posts/completed'); ?>">COMPLETED</a>
                                </li>
                            </ul>
                        </div>
                        <div class="page-title-right">
                    ...
                    <div class="row job-post-listing" <?php if($user_post['status']==3){ echo "#ab0606";} if($user_post['status']==2){ echo '#1082ad';} if($user_post['status']==1){ echo "#5a940c";} if($user_post['status']==0){ echo "#f3bc41";} ?> solid; ">
                                <div class="col-lg-12">
...
<!--                                                                <div class="price hide-on-list">
                                                                ...
                                                                <?php if(!empty($user_post['images'])){ ?>
                                                                <a style="width: 255px; height: 210px;" class="hover-effect" href="<?php echo base_url('index.php/web_panel/Job_post/job_detail?jhj=') . base64_encode($user_post['fk_job_post_id']) . '&hjfh=' . base64_encode($user_post['fk_service_cat_id']) ?>">
                                                                    <img style="max-height: 100%; max-width: 100%;" src="<?php echo base_url('uploads/job_posts/').$user_post['images'][0]['image']; ?>" class="attachment-houzez-property-thumb-image size-houzez-property-thumb-image wp-post-image" alt=""  />
                                                                </a>
                                                                <?php } else { ?>
                                                                <a style="width: 255px; height: 210px;" class="hover-effect" href="<?php echo base_url('index.php/web_panel/Job_post/job_detail?jhj=') . base64_encode($user_post['fk_job_post_id']) . '&hjfh=' . base64_encode($user_post['fk_service_cat_id']) ?>">
                                                                    <img style="max-height: 100%; max-width: 100%;" src="<?php echo base_url('uploads/job_posts/default.jpg'); ?>" class="attachment-houzez-property-thumb-image size-houzez-property-thumb-image wp-post-image" alt=""  />
                                                                </a>  
                                                                <?php } ?>
                                                            </figure>
                                                        </div>
                                                    ...
                                                    <div class="item-body table-cell">
                                                        ...
                                                        <div class="body-left table-cell">
                                                            <div class="info-row">
                                                                <h2 class="property-title"><a href="<?php echo base_url('index.php/web_panel/Job_post/job_detail?jhj=') . base64_encode($user_post['fk_job_post_id']) . '&hjfh=' . base64_encode($user_post['fk_service_cat_id']) ?>"><?php echo "Transport Job"; ?></a></h2>
                                                            ...
                                                            <div class="info-row amenities hide-on-grid" style="margin-top: 15px !important; min-height: 31px !important;">
                                                                <p><?php echo ucfirst($user_post['description']) ?></p>
                                                            </div>
                                                            <?php $datetime = explode(' ', $user_post['create_date']);
                                                                    $date = $datetime[0]; $time = $datetime[1];
                                                            ?>
                                                            <div class="info-row date hide-on-grid" style="margin-top: 0px;">
                                                        ...
                                                        <div class="body-left table-cell">
                                                            <div class="info-row">
                                                                <h2 class="property-title"><a href="<?php echo base_url('index.php/web_panel/Job_post/job_detail?jhj=') . base64_encode($user_post['fk_job_post_id']) . '&hjfh=' . base64_encode($user_post['fk_service_cat_id']) ?>"><?php echo ucfirst($user_post['title']) ?></a></h2>
                                                               <address class="property-address"><?php echo $user_post['address'] ?></address>
                                                            </div>
                                                            <div class="info-row amenities hide-on-grid" style="margin-top: 15px !important; min-height: 70px !important;">
                                                                <p><?php echo ucfirst($user_post['description']) ?></p>
                                                            </div>
                                                            <?php $datetime = explode(' ', $user_post['create_date']);
                                                                    $date = $datetime[0]; $time = $datetime[1];
...
<!--                                                            <div class="info-row price">
                                                            ...
                                                            <div class="info-row phone text-right">
                                                                <a href="<?php echo base_url('index.php/web_panel/Job_post/job_detail?jhj=') . base64_encode($user_post['fk_job_post_id']) . '&hjfh=' . base64_encode($user_post['fk_service_cat_id']) ?>" class="btn btn-primary">Read More</a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="table-list full-width hide-on-list">
                                                            ...
                                                            <div class="cell">
                                                                <div class="phone">
                                                                    <a href="<?php echo base_url('index.php/web_panel/Job_post/job_detail?jhj=') . base64_encode($user_post['fk_job_post_id']) . '&hjfh=' . base64_encode($user_post['fk_service_cat_id']) ?>" class="btn btn-primary"> Details <i class="fa fa-angle-right fa-right"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    $(".status-btn").click(function () {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                if (data) {
                    document.location.href = "user_posts";
                    //alert("updated");
