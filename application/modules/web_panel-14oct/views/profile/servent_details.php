    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="fb-profile">
                ...
                <img align="left" class="fb-image-profile thumbnail" src="<?php if (!empty($servent_detail['profile_image'])) {
    echo base_url('uploads/profile_images/') . $servent_detail['profile_image'];
} else {
...
<?php echo $servent_detail['servent_details']['about_servent']; ?>
                            ...
                            <h4>Occupation</h4>
                            <p><?php echo $servent_detail['servent_details']['occupation']; ?></p>
                            <h4>Video</h4>
                            <style>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <p><a href="<?php echo $servent_detail['servent_details']['cv_url']; ?>"> Download Now</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
