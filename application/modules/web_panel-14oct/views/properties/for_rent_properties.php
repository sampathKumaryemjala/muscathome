                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <select class="selectpicker" id="selected_status" name="is_sold" data-live-search="false" data-live-search-style="begins">
                                        <option value="" style="display: none;">All</option><option value="1" <?php if(isset($serch_inputs['is_sold'])){ if($serch_inputs['is_sold']==1){ echo 'selected';}}?>> Sold</option><option value="0" <?php if(isset($serch_inputs['is_sold'])){ if($serch_inputs['is_sold']==0){ echo 'selected';}}?>> Unsold</option></select>
                                </div>
                            </div>
