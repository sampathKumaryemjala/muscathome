                    ...
                    <div class="form-group search-long">
                        ...
                        <div class="search">
                            <div class="input-search input-icon">
                                ...
                                <input id="pac-input" type="text" name="location_keyword" value="<?php
                                if (isset($serch_inputs)) {
                                    echo $serch_inputs['location_keyword'];
                                }
                                ?>"  class="form-control" placeholder="Search property by location">

<!--                                <input class="form-control" type="text" value="" name="keyword" placeholder="Enter keyword...">-->
                                <div id="auto_complete_ajax" class="auto-complete"></div>
                            </div>
                            <?php /* <select name="city" id="city" class="selectpicker" data-live-search="false" data-live-search-style="begins">
                              <option value="">All Cities</option>
                              <?php foreach ($cities as $city) { ?>
                              <option  value="<?php echo $city['city'] ?>" <?php if (isset($serch_inputs['city'])) {
                              if ($city['city'] == $serch_inputs['city']) {
                              echo 'selected';
                              }
                              ...
                              <select name="state" id="state" class="selectpicker" data-live-search="false" data-live-search-style="begins">
                              <option value="">All Areas</option>
                              <?php foreach ($states as $state) {
                              ?>
                              <option value="<?php echo $state['state'] ?>" <?php if (isset($serch_inputs['state'])) {
                              if ($state['state'] == $serch_inputs['state']) {
                              echo 'selected';
                              }
                    ...
                    <div class="advance-fields">
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <select class="selectpicker" id="selected_status" name="is_sold" data-live-search="false" data-live-search-style="begins">
                                        <option value="" style="display: none;">All</option><option value="1" <?php
                                        if (isset($serch_inputs['is_sold'])) {
                                            if ($serch_inputs['is_sold'] == 1) {
                                                echo 'selected';
                                            }
                                        }
                                        ?>> Sold</option><option value="0" <?php
                                                                                                    if (isset($serch_inputs)) {
                                                                                                        if ($serch_inputs['is_sold'] == 0) {
                                                                                                            echo 'selected';
                                                                                                        }
                                                                                                    }
                                                                                                    ?>> Unsold</option></select>
                                </div>
                            </div>

                            <div class="col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <select class="selectpicker" id="selectpicker" class="property_type" name="property_type" data-live-search="false" data-live-search-style="begins">
                                        <option value="" style="display: none;">All Types</option>
                                        <?php foreach ($property_types as $property_type) {
                                            ?>
                                            <option value="<?php echo $property_type['id'] ?>" <?php
                                            if (isset($serch_inputs['property_type'])) {
                                                if ($property_type['id'] == $serch_inputs['property_type']) {
                                                    echo 'selected';
                                                }
                                            }
                                            ?> ><?php echo $property_type['name'] ?></option>
                                                <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <select name="beds" id="beds" class="selectpicker" data-live-search="false" data-live-search-style="begins" title="">
                                        <option value="" style="display: none;">Beds</option>
                                        <?php for ($i = 1; $i <= 10; $i++) { ?>
                                            <option value="<?php echo $i ?>" <?php
                                            if (isset($serch_inputs['beds']) && $serch_inputs['beds'] == $i) {
                                                echo 'selected';
                                            }
                                            ?> ><?php echo $i ?></option>
                                                <?php } ?>
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <select name="baths" id="baths" class="selectpicker" data-live-search="false" data-live-search-style="begins" title="">
                                        <option value="" style="display: none;">Baths</option>
                                        <?php for ($i = 1; $i <= 10; $i++) { ?>
                                            <option value="<?php echo $i ?>" <?php
                                            if (isset($serch_inputs['baths']) && $serch_inputs['baths'] == $i) {
                                                echo 'selected';
                                            }
                                            ?> ><?php echo $i ?></option>
                                                <?php } ?>
                            ...
                            <div class="col-sm-6 col-xs-6">
                                <div class="form-group">
                                    <select name="area" id="area" class="selectpicker" data-live-search="false" data-live-search-style="begins" title="">
                                        ...
                                        <option value="1" <?php if (isset($serch_inputs['square_ft_min']) && $serch_inputs['square_ft_min'] <= 600) {
                                                    echo "Selected";
                                                } ?>>0 - 600 sqm</option>
                                        <option value="2"<?php if (isset($serch_inputs['square_ft_min']) && $serch_inputs['square_ft_min'] > 600) {
                                                    echo "Selected";
                                                } ?>>> 600 sqm</option>                                    
                                    </select>
                                </div>
                            </div>
                            <input type="hidden" name="square_ft_min" id="square_ft_min" value="<?php if (isset($serch_inputs['square_ft_min'])) {
                                                    echo $serch_inputs['square_ft_min'];
                                                } ?>">
                            <input type="hidden" name="square_ft_max" id="square_ft_max" value="<?php if (isset($serch_inputs['square_ft_max'])) {
                                echo $serch_inputs['square_ft_max'];
                            } ?>">
                            <!--                            <div class="col-sm-3 col-xs-6">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control number" value="<?php
//if (isset($serch_inputs['square_ft_min'])) {
//    echo $serch_inputs['square_ft_min'];
//}
                                                ?>" name="square_ft_min" id="square_ft_min" placeholder="Min Area (SqM)">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-3 col-xs-6">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control number" value="<?php
//if (isset($serch_inputs['square_ft_max'])) {
//    echo $serch_inputs['square_ft_max'];
//}
                                                ?>"  name="square_ft_max" id="square_ft_max" placeholder="Max Area (SqM)">
                                                            </div>
                                                        </div>-->
                            ...
                            <div class="col-sm-6 col-xs-6" style="padding-left:1%">
                                <div class="range-advanced-main">
                                    <div class="range-text">
                                        <input type="hidden" value="<?php
                                               if (isset($serch_inputs['price_min'])) {
                                                   echo $serch_inputs['price_min'];
                                               }
                                               ?>" name="price_min" id="price_min" class="min-price-range-hidden range-input" readonly >
                                        <input type="hidden" value="<?php
                                               if (isset($serch_inputs['price_max'])) {
                                                   echo $serch_inputs['price_max'];
                                               }
                                               ?>" name="price_max" id="price_max" class="max-price-range-hidden range-input" readonly >
...
<div id="section-body" class="">
    ...
    <div class="container">
        ...
        <div class="page-title breadcrumb-top">
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb"><li itemscope ><a itemprop="url" href="<?php echo site_url('web_panel/home'); ?>"><span itemprop="title">Home</span></a></li><li>For Buy</li></ol>            <div class="page-title-left">
                        <h2>For Buy</h2>
                    </div>
                                                            ...
                                                            <figure class="item-thumb">
                                                             ...
                                                             if (!empty($property['images'])) {
                                                                ...
                                                                <ul class="actions">
                                                                    ...
                                                                    <li>
                                                                        <span class="add_fav" data-placement="top" data-toggle="tooltip"  data-original-title="<?php
            ...
            <?php if (isset($property['agent_detail']['name'])) { ?>
                                                        ...
                                                        <div class="table-list full-width hide-on-list">
                                                            <div class="cell">
                                                                ...
                                                                <p><?php if($property['property_type_id'] != 1 && $property['property_type_id'] != 4 && $property['property_type_id'] != 10){ ?><span>Beds: <?php echo $property['beds'] ?></span><span>Baths: <?php echo $property['baths'] ?></span>
                                                                <?php } ?>
                                                                <span>Sq M: <?php echo $property['property_size'] ?></span></p>
                                                                </div>
                                                            </div>
    ...
    ?>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-md-offset-0 col-sm-offset-3 container-sidebar houzez_sticky">
                <aside id="sidebar" class="sidebar-white">
                    <div id="houzez_mortgage_calculator-5" class="widget widget-calculate" style="border:1px solid #ccc; background: #efefef; border-top-left-radius: 2em; border-bottom-right-radius: 2em;"><div class="widget-top"><h3 class="widget-title">Calculator Repayments</h3></div>
                                            ...
                                            <div class="figure-block">
                                                <figure class="item-thumb">
                                                    ...
                                                    if (!empty($feature['images'])) {
                                                        echo base_url('uploads/properties/images/') . $feature['images'][0]['image'];
                                                    } else {
                                                        echo base_url('uploads/properties/images/default.jpg');
                                                    }
                                                    ?>" class="attachment-houzez-property-thumb-image size-houzez-property-thumb-image wp-post-image" alt="" /></a>
...
?>
                    ...
                    <div id="houzez_property_taxonomies-12" class="widget widget-categories">
                        <div class="widget-top"><h3 class="widget-title">Property Type</h3></div><hr>
                        <div class="widget-body">
                            <ul class="children">
<?php foreach ($property_types as $property_type) { ?>
                                        ...
                                        <div class="media-left">
                                            <figure class="item-thumb">
                                                <a class="hover-effect" href="<?php echo base_url(); ?>index.php/web_panel/Properties/property_details?prjkl=<?php echo base64_encode($recent_view['id']); ?>">
                                                    <img width="150" height="110" src="<?php
        if (!empty($recent_view['images'])) {
            echo base_url('uploads/properties/images/') . $recent_view['images'][0]['image'];
        } else {
            echo base_url('uploads/properties/images/default.jpg');
        }
        ?> "></a>
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="amenities">
                                                <?php if($recent_view['property_type_id'] != 1 && $recent_view['property_type_id'] != 4 && $recent_view['property_type_id'] != 10){ ?><p><?php echo $recent_view['beds']; ?> beds • <?php echo $recent_view['beds']; ?> baths • <?php } echo $recent_view['property_size']; ?> Sq M</p>
            ...
            ?>
                        ...
                        var a<?php echo $i; ?> = {
                            info: '<strong> <?php echo $property['property_name']; ?></strong><br>\
                                   ...
                                   <img height="120" width="160" src="<?php
            if (!empty($property['images'])) {
                echo base_url('uploads/properties/images/') . $property['images'][0]['image'];
            } else {
                echo base_url('uploads/properties/images/default.jpg');
