<?php //pre($this->session->userdata['active_user_data']['user_type']); die; 
                ...
                <div class="tab-content"> 
                        ...
                        <form id="login_users" method="post" role="form" autocomplete="off" enctype="multipart/form-data" class="form_style">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <label for="f-option" style="margin: 1px -60px !important;">User</label>
                                    <!-- <div class="check"></div> -->
                                </li>

                                <li>
                                    <input type="radio"  class="sel_user"  id="s-option" value="1" name="toggler">
                                    <label for="s-option" style="margin: 1px -60px !important;">Agent</label>
                            ...
                            <div class="forget-block clearfix">
                                ...
                                <div class="form-group pull-right">
                                    <a href="#" data-toggle="modal" data-dismiss="modal" title="forgot password" data-target="#pop-reset-pass">forgot password</a>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade">
                        ...
                        <ul style="list-style: none;">
                            ...
                            <li style="float: left; padding: 2px 133px;">
                        ...
                        <div id="form_user">
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            I agree with your <a href="<?php echo base_url('index.php/web_panel/Home/terms'); ?>" title="Terms & Conditions" target="_blank" >Terms & Conditions</a>.
                                        </label>
                                    </div>
                                </div>
                            ...
                            <a href="<?php echo $facebook_authUrl; ?>" class="btn btn-social btn-bg-facebook btn-block"><i class="fa fa-facebook" title="Facebook login"></i> login with facebook</a>

                            <a href="<?php echo $google_authUrl; ?>" class="btn btn-social btn-bg-google-plus btn-block"><i class="fa fa-google-plus" title="Gmail login"></i> login with Google</a>
                        </div>
                        <div id="form_agent">  
                            ...
                            <form id="register_agent_form" action="<?php echo base_url('index.php/web_panel/register/register_agent/register_agent_submit'); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group login-select ">
                                    <select class="form-control" name="ser_category" data-live-search="false" title="category" id="reg_agent_category" required>
                                ...
                                <div class="doc-upload" style="margin-top: 20px;">
                                    ...
                                    <p class="siginup-policy-txt">By signing up, you agree to <a href="<?php echo base_url('index.php/web_panel/Home/terms'); ?>" title="Terms of use" target="_blank" >terms of use</a> </p>
                                </div>
...
<header id="header-section" class="header-section-4 header-main nav-left hidden-sm hidden-xs" data-sticky="1">
    <div class="container-fluid" style="padding: 0px 80px;"> 
        <div class="header-left">
            <div class="logo">
                <a href="<?php echo base_url('index.php/web_panel/home'); ?>" title="Home">
            ...
            <nav class="navi main-nav" >
                <ul>
                    ...
                    //pre($url);
                    $services_details = file_get_contents($url);
                        ...
                        <ul class="sub-menu">
                            ...
                            if ($services_details['Result']) {
                                foreach ($services_details['Result'] as $service) {
                                    ?>
                                    <li><img style="float:left; margin: 10px 15px 10px;" height="24" width="24" src="<?php if(!empty($service->icon)){echo $service->icon;} else{ echo base_url('uploads/services/icons/icon.png');}?>">
                                        <a href="javascript:void(0)" title="<?php echo $service->name; ?>"><?php echo $service->name; ?></a>
                                        <ul class="sub-menu">
                                            <?php foreach ($service->sub_categories as $sub) { ?>
                                            <li><img style="float:left; margin: 10px 15px 10px;" height="24" width="24" src="<?php if(!empty($sub->icon)){echo $sub->icon;} else{ echo base_url('uploads/services/icons/icon.png');}?>"><a href="<?php echo base_url('index.php/web_panel/Job_post?ghvj=') . base64_encode($sub->id); ?> " title="<?php echo $sub->name; ?>" ><?php echo $sub->name; ?></a></li>
        <?php } ?>
                                        </ul>
                                    </li>
                                <?php
                    ...
                    <li>
                        <a href="<?php echo base_url('index.php/web_panel/Profile/add_property');?>" class="dropbtn" title="Add Property" ><span> Add Property</span></a>
                    ...
                    <?php } ?>
                    <li>
                        <a href="<?php echo base_url('index.php/web_panel/Home/news'); ?>" class="dropbtn" title="News">News</a>
                    </li>
...
<?php } ?>
                    ...
                    <li>
                        <div class="top-login subMenu">
                            <form method="post">
                                <a href="javascript:void(0)" id="lang_chng" class="dropbtn" title="Change language"><span>
            ...
            <ul class="account-action">
                <li>
                    ...
                    <div class="account-dropdown">
                        <ul>
                            <li> <a href="#" data-toggle="modal" data-target="#pop-login" title="Log in / Register" > <i class="fa fa-user"></i> Log in / Register </a></li>
                        </ul>
                    </div>
                </li>
                 <li>
                    <a href="javascript:void(0)" id="lang_chng" class="dropbtn" title="Change language"><span class="user-icon">
                        <?php if (isset($this->session->userdata['lang']) && $this->session->userdata['lang'] == 1) {
                            echo "AR";
                        } else {
                            echo "EN";
