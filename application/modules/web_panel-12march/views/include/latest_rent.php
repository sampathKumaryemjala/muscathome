                        ...
                        <div class="col-sm-12">
                            <div class="module-title-nav clearfix">
                                ...
                                <div class="module-nav">
                                    ...
                                    <a href="<?php echo base_url('index.php/web_panel/Properties/for_rent_properties'); ?>" class="btn btn-carousel btn-sm">All</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                                                ...
                                                <div class="item-body">
                                                    ...
                                                    <div class="body-left">
                                                        <div class="info-row">
                                                            ...
                                                            <h2 class="property-title" style="width: 50%;"><a href="<?php echo base_url(); ?>index.php/web_panel/Properties/property_details?prjkl=<?php echo base64_encode($property['id']); ?>"><?php echo $property['location']; ?></a></h2>
                                                        ...
                                                        <div class="table-list full-width info-row" style="margin-top: 10px !important">
                                                            <div class="cell" style="width: 100%;">
                                                                <div class="info-row amenities">
                                                                    <p>
                                                                        <span><i class="fa fa-bed" aria-hidden="true"></i> Beds: <?php echo $property['beds']; ?></span>
                                                                        <span><i class="fa fa-tint" aria-hidden="true"></i> Baths: <?php echo $property['baths']; ?></span>
