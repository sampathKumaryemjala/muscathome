...
foreach ($properties as $property) {
    if ($property['status'] == 1) {
        ...
        ?></span></div>
                                                            <a class="hover-effect property-img-thumb " href="<?php echo base_url(); ?>index.php/web_panel/Properties/property_details?prjkl=<?php echo base64_encode($property['id']); ?>">
                                                                <img width="385" height="184" src="<?php if (!empty($property['images'])) {
                                                            ...
                                                            <ul class="actions">
                                                                ...
                                                                <li>
                                                                    <span class="add_fav" data-placement="top" data-toggle="tooltip"  data-original-title="<?php if($property['is_fav']==0){ echo "Add Favorite"; } else { echo "Remove Favorite";} ?>">
    ...
    <?php }
} } else { echo "<h3>Couldn't find anything matching your search criteria!</h3>"; } ?>
                            </div>
                        </div>