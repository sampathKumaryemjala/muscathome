                         ...
                         <div class="col-md-9 col-sm-12 white-block" style="min-height: 450px">
                            <div class="col-md-9 col-sm-12 white-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?php echo $users['fk_service_cat_name'] ?>" id="category" name="category" placeholder="Category" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="mobile">Sub Category</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?php echo $users['fk_service_sub_cat_name'] ?>" id="sub_category" name="sub_category" placeholder="Sub category" readonly>
                                    </div>
                                </div>
