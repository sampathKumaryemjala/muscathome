...
<!--                        <i class="rui-icon rui-icon-arrow-right-small"></i>-->
               ...
               <div class="download-native-app">
                <center>
                    <div class="app-image">
                        <a href=""><img src="<?php echo base_url('web_assets/images/apple_store.png'); ?>" style="width: 175px;">
                        </a>
                        <a href=""><img src="<?php echo base_url('web_assets/images/google-play.png'); ?>" style="width: 175px;">
                        </a>
                    </div>
                    <br>
