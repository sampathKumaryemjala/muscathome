...
<style>
    ...
    #map1{ width:96%; height: 300px; margin: auto; margin-bottom: 2%;}
    #map2{ width:96%; height: 300px; margin: auto; margin-bottom: 2%; }
    .job_post_submit{    
        margin-left: 15px;
        margin-bottom: 30px;}
        ...
        <div class="page-title breadcrumb-top">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="page-title-right"><ol class="breadcrumb"><li ><a href="#">Services</a></li><li class="active"><?php echo $subs[0]['cat_name']; ?></li></ol></div>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 list-grid-area container-contentbar job-description">
                    <div class="job-form">
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="required" for="title">Source House no. / Flat no. / Building no.</label><br />
                                    <input type="text" name="h_no_s" id="h_no_s" value="" maxlength="12" size="40" class="form-control" aria-required="true" aria-invalid="false" placeholder="Enter House no. / Flat no. / Building no. of source address" required/>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="required" for="title">Source Address</label><br />
                                    <input type="text" name="source" id="source" value="" size="40" class="form-control" aria-required="true" aria-invalid="false" placeholder="Click on map to get location" required/>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12" style="display:none">
                                <div class="form-group">
                                    <label class="required" for="source_latitude">Latitude</label><br />
                                    <input class="form-control" name="source_latitude" type="text" id="lat1" placeholder="Latitude" readonly="yes"><br>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12" style="display:none">
                                <div class="form-group">
                                    <label class="required" for="source_longitude">longitude</label><br />
                                    <input class="form-control" name="source_longitude" type="text" id="lng1" placeholder="longitude" readonly="yes">
                                </div>
                            </div>
                            <div class="picker-map"id="map1"></div>
                        </div>
                        
                        <div class="col-sm-12 col-xs-12">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="required" for="title">Destination House no. / Flat no. / Building no.</label><br />
                                    <input type="text" name="h_no_d" id="h_no_d" maxlength="12" value="" size="40" class="form-control" aria-required="true" aria-invalid="false" placeholder="Enter House no. / Flat no. / Building no. of destination address" required/>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="required" for="title">Destination Address</label><br />
                                    <input type="text" name="destination" id="destination" value="" size="40" class="form-control" aria-required="true" aria-invalid="false" placeholder="Click on map to get location" required/>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12" style="display:none">
                                <div class="form-group">
                                    <label class="required" for="dest_latitude">Latitude</label><br />
                                    <input class="form-control" name="dest_latitude" type="text" id="lat2" placeholder="Latitude" readonly="yes"><br>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12" style="display:none">
                                <div class="form-group">
                                    <label class="required" for="dest_longitude">longitude</label><br />
                                    <input class="form-control" name="dest_longitude" type="text" id="lng2" placeholder="longitude" readonly="yes">
                                </div>
                            </div>
                            <div class="picker-map"id="map2"></div>
                        </div>
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label>Time</label>
                                    <select name="timed" class="form-control" required>
                            ...
                            <!--                            <div class="col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="items" class="form-control " placeholder="Select Job date" type="number" required>
                                                            </div>
                                                        </div>-->
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="required" for="mobile">Phone</label><br />
                                    <input type="text" id="mobile" maxlength="16" name="mobile" value="" size="40" class="form-control" aria-required="true" aria-invalid="false" required placeholder="Enter mobile number"/>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="required" for="budget">Job Budget</label><br />
                                    <span class=""><input type="text" maxlength="8" name="budget" value="" size="40" class="form-control" aria-required="true" aria-invalid="false" id="job_budget" placeholder="Enter job budget" required /></span> </p>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="required" for="description">Job Description</label><br />
                                    <textarea class="form-control" name="description" rows="4" placeholder="Enter description" maxlength="250" id="message" data-bv-field="message" required></textarea>
                            ...
                            <div class="col-sm-6 col-xs-12">
                                ...
                                <fieldset>
                                    <div class="form-group radio-option">
                                        <legend><p class="radio-heading">I can assist the movers</p></legend>
                                        <label class="radio-inline">
                                            <input type="radio" name="is_assist" value="1" checked>Yes
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="is_assist" value="0" >No
                                        </label>
                                    </div>
                                </fieldset>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <fieldset>
                                    <div class="form-group radio-option">
                                        <legend><p class="radio-heading">Insure them</p></legend>
                                        <label class="radio-inline">
                                            <input type="radio" name="is_insured" value="1" checked>Yes
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="is_insured" value="0" >No
                                        </label>
                                    </div>
                                </fieldset>
                            </div>
                        ...
                        <!--                        <div class="col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="required" for="description">Job Description</label><br />
                                                        <textarea class="form-control" name="description" rows="4" id="message" data-bv-field="message"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-xs-12">
                                                    <div class="form-group">
                        ...
                        <div class="col-sm-12 col-xs-12" style="margin:20px 15px" >
                            <div class="form-group">
                        ...
                        <div class="col-sm-12 col-xs-12" style="margin:10px 0" ><?php if (!$this->session->userdata('active_user_data')) { ?> 
                                <button type="button"  id="job_post_submit_without_login" class="btn btn-secondary btn-request job_post_submit_without_login">Send</button>
                            <?php } else { ?>
                                <button type="submit"  id="job_post_submit" class="btn btn-secondary btn-request job_post_submit">Send</button>
                            <?php } ?>
                        </div>
                    ...
                    <div class="widget widget-range">
                        <div class="widget-body services-menu">
                            <ul><?php foreach ($subs as $sub) { ?>
                                    ...
                                    <li><img height="24" src="<?php echo $sub['icon']; ?>"></span><a  href="<?php echo base_url('/index.php/web_panel/Job_post?ghvj=') . base64_encode($sub['sub_id']); ?> " class="<?php
...
//values to our textfields so that we can save the location.
    function markerLocation1() {
        ...
        document.getElementById('lat1').value = currentLocation1.lat(); //latitude
        document.getElementById('lng1').value = currentLocation1.lng(); //longitude


        var newlat = currentLocation1.lat();
        var newlng = currentLocation1.lng();
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.status) {
                    ...
                    $('#check_promocode').prop('checked', true);} else {
                //alert('data');
                    $('#promo_validate_msg').text(data.message);
