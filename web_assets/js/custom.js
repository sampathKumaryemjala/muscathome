...
(function($){
    ...
    if(slider_price.length >0) {
        slider_price.slider({
            ...
            slide: function (event, ui) {
                min_price.val("OMR " + ui.values[0]);
                max_price.val("OMR " + ui.values[1]);
            }
        });
        min_price.val("OMR " + slider_price.slider("values", 0));
        max_price.val("OMR " + slider_price.slider("values", 1));
    }
    ...
    if(price_range_advanced.length >0) {
        price_range_advanced.slider({
            ...
            slide: function (event, ui) {
                min_price_range_hidden.val("OMR " + addCommas(ui.values[0]));
                max_price_range_hidden.val("OMR " + addCommas(ui.values[1]));

                min_price_range.text("OMR " + addCommas(ui.values[0]));
                max_price_range.text("OMR " + addCommas(ui.values[1]));
            }
        });

        min_price_range_hidden.val("OMR " + addCommas(price_range_advanced.slider("values", 0)));
        max_price_range_hidden.val("OMR " + addCommas(price_range_advanced.slider("values", 1)));

        min_price_range.text("OMR " + addCommas(price_range_advanced.slider("values", 0)));
        max_price_range.text("OMR " + addCommas(price_range_advanced.slider("values", 1)));
    }
    
    
    var price_range_advanced_rent = $( ".price-range-advanced_rent");
    var min_price_range_hidden_rent = $(".min-price-range-hidden_rent");
    var max_price_range_hidden_rent = $(".max-price-range-hidden_rent");
    var min_price_range_rent = $(".min-price-range_rent");
    var max_price_range_rent = $(".max-price-range_rent");
    //alert(min_price_range_hidden);
    if(price_range_advanced_rent.length >0) {
        price_range_advanced_rent.slider({
            range: true,
            min: 100,
            max: 100000,
            values: [100, 100000],
            slide: function (event, ui) {
                min_price_range_hidden_rent.val("OMR " + addCommas(ui.values[0]));
                max_price_range_hidden_rent.val("OMR " + addCommas(ui.values[1]));

                min_price_range_rent.text("OMR " + addCommas(ui.values[0]));
                max_price_range_rent.text("OMR " + addCommas(ui.values[1]));
            }
        });

        min_price_range_hidden_rent.val("OMR " + addCommas(price_range_advanced_rent.slider("values", 0)));
        max_price_range_hidden_rent.val("OMR " + addCommas(price_range_advanced_rent.slider("values", 1)));

        min_price_range_rent.text("OMR " + addCommas(price_range_advanced_rent.slider("values", 0)));
        max_price_range_rent.text("OMR " + addCommas(price_range_advanced_rent.slider("values", 1)));
    }
